                    ...
                    <div id="sidebar-menu" className="sidebar-menu">
                        <ul>
                            ...
                            <li className = {`submenu ${pathnames.includes('/home/fac/transaction-list') ? 'active' : ''}`} > 
                                <a href="#">
                                    <FaBuffer/> <span>Insurance history</span> <span className="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li className = {pathnames.includes('/home/fac/transaction-list') ? 'active' : ''} onClick= {()=> setPathnames("/home/fac/transaction-list")}>
                                        <Link to ="/home/fac/transaction-list">Insurance List</Link>
                                    </li>
                            ...
                            <li className = {`submenu ${pathnames.includes('/home/fac/statistics-list') ? 'active' : pathnames.includes('/home/fac/sales-list') ? 'active' : pathnames.includes('/home/fac/error-list') ? 'active' : ''}`}>								
									<a href="#">
									...
									<ul>
										<li className = {pathnames.includes('/home/fac/statistics-list') ? 'active' : ''} onClick= {()=> setPathnames("/home/fac/statistics-list")}>
											<Link to = "/home/fac/statistics-list">Product List</Link>
										</li>
										<li className = {pathnames.includes('/home/fac/sales-list') ? 'active' : ''} onClick= {()=> setPathnames("/home/fac/sales-list")}>
											<Link to = "/home/fac/sales-list">Sale List</Link>
										</li>
										<li className = {pathnames.includes('/home/fac/error-list') ? 'active' : ''} onClick= {()=> setPathnames("/home/fac/error-list")}>
											<Link to = "/home/fac/error-list"> Error Statistics</Link>
										</li>

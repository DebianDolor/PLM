                ...
                <div className="sidebar-inner">
                    <div id="sidebar-menu" className="sidebar-menu">
                        <ul>
                            ...
                            <li className = {`submenu ${pathnames.includes('/home/sto/insurance-list') ? 'active' : pathnames.includes('/home/sto/product-recall') ? 'active' : pathnames.includes('/home/sto/receive-product') ? 'active' : ''}`}>								
									<a href="#">
										<FaBuffer/> <span> Insurance Support</span> <span className="menu-arrow"></span>
									</a>
									<ul>
										...
										<li className = {pathnames.includes('/home/sto/receive-product') ? 'active' : ''} onClick={()=> setPathnames("/home/sto/receive-product")}>
											<Link to = "/home/sto/receive-product">ReceiveProduct</Link>
										</li>
                            ...
                            <li className = {`submenu ${pathnames.includes('/home/sto/transaction-list') ? 'active' : pathnames.includes('/home/sto/sale-list') ? 'active' :''}`}> 
                                <a href="#">
                                    <FaCodepen/><span>Statistics</span> <span className="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li className = {pathnames.includes('/home/sto/transaction-list') ? 'active' : ''} onClick={()=>setPathnames("/home/sto/transaction-list")}>
                                        <Link to ="/home/sto/transaction-list">Product List</Link>
                                    </li>
									<li className = {pathnames.includes('/home/sto/sale-list') ? 'active' : ''} onClick={()=>setPathnames("/home/sto/sale-list")}>
                                        <Link to ="/home/sto/sale-list">Sale List</Link>
                                    </li>

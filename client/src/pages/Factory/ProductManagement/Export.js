...
export function Export() {
    ...
    const handleSubmit =(e)=>{
        ...
        if(receiver.current.value=="" ||producline.current.value=="" ||productID.current.value==""||quantity.current.value=="" ){
        ...
        else if(receiver.current.value != "Sto01"){
            setWarning("Receiver not found");
        } 
        else{
                                ...
                                <Row>
                                    ...
                                    <Col xs={12} sm={6}>
                                        <Form.Group className="mb-2">
                                            ...
                                            <Form.Control type="text" ref={receiver} onFocus={handleFocus}/>
                                        </Form.Group>

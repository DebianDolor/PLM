...
export function ProductRecall() {
    ...
    const handleSubmit =(e)=>{
        ...
        if(productName.current.value=="" ||producline.current.value=="" ||productID.current.value==""||importDate.current.value=="" ){
                                ...
                                <Row>
                                    ...
                                    <Col xs={12} sm={6}>
                                        <Form.Group >
                                            ...
                                            <Form.Control  type="text" ref={importDate} onFocus={handleFocus}/>
                                        </Form.Group>
                                    </Col>

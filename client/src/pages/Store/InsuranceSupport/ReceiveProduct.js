...
export function ReceiveProduct() {
    ...
    const handleSubmit =(e)=>{
        ...
        if(productName.current.value=="" ||producline.current.value=="" ||productID.current.value==""||orderID.current.value=="" ){
    ...
    return (
        <div>
            ...
            <div className="page-header">
                <Row>
                    <Col sm={12}>
                        <h3 className="page-title">Receive product</h3>
                    ...
                    <Card>
                        <Card.Body>
                            <Form>
                                <Row>
                                    <Col sm={12}>
                                        <h5 className="form-title"><span>Receive product</span></h5>
                                    </Col>

                                    <Col xs={12} sm={6}>
                                        <Form.Group className="mb-2">
                                            <Form.Label>Customer ID</Form.Label>
                                            <Form.Control type="text" ref={customerID} onFocus={handleFocus}/>
                                        </Form.Group>
                                    ...
                                    <Col xs={12} sm={6}>
                                        <Form.Group className="mb-3">
                                            ...
                                            <Form.Control type="text" ref={customerName} onFocus={handleFocus} />
                                        </Form.Group>
                                    </Col>
                                    <Col xs={12} sm={6}>
                                        <Form.Group className="mb-2">
                                    ...
                                    <Col xs={12} sm={6}>
                                        <Form.Group >
                                            ...
                                            <Form.Control  type="text" ref={orderID} onFocus={handleFocus}/>
                                        </Form.Group>
                                    </Col>
